...
### 6.1 检查是否存在 SKILL_SETUP.md

```bash
ls {baseDir}/crawlers/*/SKILL_SETUP.md
```

### 6.2 对存在 SKILL_SETUP.md 的爬虫
...
| npm install 失败 | 检查 Node.js 版本 >= 20，尝试删除 `node_modules` 和 `package-lock.json` 后重试 |
